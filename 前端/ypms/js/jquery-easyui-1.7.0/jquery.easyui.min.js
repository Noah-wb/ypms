...
$.ajax({type:opts.method,url:opts.url,xhrFields: {withCredentials: true},crossDomain: true,data:_1d0,dataType:"json",success:function(data){
_1d1(data);
},error:function(){
...
$.ajax({type:opts.method,xhrFields: {withCredentials: true},crossDomain: true,url:opts.href,cache:false,data:_27c,dataType:"html",success:function(data){
_27d(data);
},error:function(){
...
var data={};
data[_56c[1]]=_56b;
var _56d=$.ajax({url:_56c[0],dataType:"json",xhrFields: {withCredentials: true},crossDomain: true,data:data,async:false,cache:false,type:"post"}).responseText;
return _56d=="true";
...
$.ajax({url:opts.url,xhrFields: {withCredentials: true},crossDomain: true,type:"post",xhr:function(){
...
$.ajax({url:data,data:_642,dataType:"json",xhrFields: {withCredentials: true},crossDomain: true,success:function(data){
_643(data);
},error:function(){
...
$.ajax({type:opts.method,xhrFields: {withCredentials: true},crossDomain: true,url:opts.url,data:_91c,dataType:"json",success:function(data){
_91d(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,xhrFields: {withCredentials: true},crossDomain: true,data:_a9f,dataType:"json",success:function(data){
_aa0(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,xhrFields: {withCredentials: true},crossDomain: true,data:_b77,dataType:"json",success:function(data){
_b78(data);
},error:function(){
